...
public class Chat2Model(MlflowChatService chatService, IConfiguration configuration,
    ILogger<Chat2Model> logger) : ChatPageModel(chatService, logger)
{
    ...
    public override string ModelName => configuration["Mlflow:Model"] ?? "gpt-5.4-mini";
